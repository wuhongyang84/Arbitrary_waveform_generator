...
################################################################
# This is a generated script based on design: dds_fir
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Coefficient_File {../../../../../../firLPF_new1.coe} \
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins mult_gen_0/CLK]
  ...
  connect_bd_net -net fir_compiler_0_m_axis_data_tdata [get_bd_ports m_axis_data_tdata_0] [get_bd_pins fir_compiler_0/m_axis_data_tdata]
