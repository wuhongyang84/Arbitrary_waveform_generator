...
HD_PWD='C:/Xilinx/Arbitrary_Waveform_Generator/Arbitrary_Waveform_Generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_sun.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_sun.tcl -notrace
