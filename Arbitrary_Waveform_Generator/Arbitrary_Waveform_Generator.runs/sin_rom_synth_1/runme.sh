...
HD_PWD='C:/Xilinx/Project/Arbitrary Waveform Generator/Arbitrary_Waveform_Generator/Arbitrary_Waveform_Generator.runs/sin_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sin_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sin_rom.tcl
