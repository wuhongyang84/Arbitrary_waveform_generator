...
HD_PWD='C:/Xilinx/Arbitrary_Waveform_Generator/Arbitrary_Waveform_Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_sun.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_sun.tcl
